        ...
        <div class="row">
          <div class="col-md-6">
            <nav class="navbar navbar-expand-lg bg-primary">
              <a class="navbar-br/and" href="#">Menu</a>
          ...
          <div class="col-md-6">
            <nav class="navbar navbar-expand-lg bg-danger">
              <a class="navbar-br/and" href="#">Icons</a>
              <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse"
      ...
      <div id="navbar">
        <div class="navigation-example" style={{backgroundImage: "url('%PUBLIC_URL%/assets/img/ilya-yakover.jpg');"}}>
          ...
          <nav class="navbar navbar-expand-lg bg-info">
            <div class="container">
              <a class="navbar-br/and" href="#">Info Color</a>
              <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse"
          ...
          <nav class="navbar navbar-expand-lg bg-success">
            <div class="container">
              <a class="navbar-br/and" href="#">Success Color</a>
              <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse"
              ...
              <div class="navbar-collapse collapse show" id="navbar-success">
                <ul class="navbar-nav ml-auto">
                  <li class="nav-item">
          ...
          <nav class="navbar navbar-expand-lg bg-warning">
            <div class="container">
              <a class="navbar-br/and" href="#">Warning Color</a>
              <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse"
          ...
          <nav class="navbar navbar-expand-lg bg-danger">
            <div class="container">
              <a class="navbar-br/and" href="#">Danger Color</a>
              <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse"
              ...
              <div class="navbar-collapse collapse show" id="navbar-danger">
                <ul class="navbar-nav ml-auto">
                  <li class="nav-item">
          ...
          <nav class="navbar navbar-expand-lg navbar-transparent pt-0">
            <div class="container">
              <a class="navbar-br/and" href="#">Transparent</a>
              <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse"
          ...
          <div class="col-md-6">
            ...
            <div id="my-tab-content" class="tab-content text-center">
              <div class="tab-pane active" id="home" role="tabpanel">
                <p>Larger, yet dramatically thinner. More powerful, but remarkably power efficient. With a smooth metal
      ...
      <div class="alert alert-danger alert-with-icon" data-notify="container">
        <div class="container">
          <div class="alert-wrapper">
            ...
            <div class="message"><i class="nc-icon nc-bell-55"></i> This is a notification with close button and icon
              and have many lines. You can see that the icon and the close button are always vertically aligned. This is
              a beautiful notification. So you don't have to worry about the style.</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-12">
            ...
            <a href="https://nucleoapp.com/?ref=1712" class="btn btn-outline-danger btn-round" target="_blank">View All
              Icons</a>
          </div>
          <div class="col-lg-6 col-md-12">
